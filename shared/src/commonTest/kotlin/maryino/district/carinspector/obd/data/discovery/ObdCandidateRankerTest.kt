...
class ObdCandidateRankerTest {
    ...
    fun wifiRememberedAndGatewaySourcesRankAboveStaticAndSubnetSources() {
        val subnet = wifi(id = "subnet", source = WifiCandidateSource.SubnetScan("192.168.0.20"))
        val static = wifi(id = "static", source = WifiCandidateSource.StaticKnown("192.168.0.10"))
        ...
        assertEquals(listOf("remembered-source", "gateway", "static", "subnet"), ranked.ids())
    }
    ...
    private fun classic(
        ...
        adapter(
            ...
            target = ObdConnectionTarget.BluetoothClassic(
                deviceAddress = "00:11:22:33:44:${id.takeLast(2)}",
                deviceName = name
            ),
